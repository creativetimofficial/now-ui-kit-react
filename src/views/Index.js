              ...
              <Row className="justify-content-md-center">
                <Col className="text-center" lg="8" md="12">
                  ...
                  <h5 className="description">
                    ...
                    below to navigate to Creative Tim or Invision where you can
                    find the kit in HTML or Sketch/PSD format. Start a new
              ...
              <Row className="text-center mt-5">
                <Col className="ml-auto mr-auto" md="8">
                  ...
                  <h5 className="description">
                    ...
                    pages. Start Your Development With A Badass Bootstrap 4 UI
                    Kit.
                  </h5>
                </Col>
                <Col md="12">
