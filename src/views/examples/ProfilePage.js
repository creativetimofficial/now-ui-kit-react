...
<Button className="btn-round" color="primary" href="#pablo" onClick={e =>
 e.preventDefault()} size="lg">
Follow
</Button>
<Button className="btn-round btn-icon" color="default" href="#pablo" id="tooltip515203352" onClick={e =>
 e.preventDefault()} size="lg">
<i className="fab fa-twitter">
</i>
</Button>
...
<Button className="btn-round btn-icon" color="default" href="#pablo" id="tooltip340339231" onClick={e =>
 e.preventDefault()} size="lg">
<i className="fab fa-instagram">
</i>
</Button>
...
<Col md="6">
<img alt="..." className="img-raised" src={require("assets/img/bg1.jpg")}>
</img>
