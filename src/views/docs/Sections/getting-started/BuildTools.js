...
<title>
Build tools - Now UI Kit by Creative Tim
</title>
...
<ul>
<li>
You will find all the branding colors inside <code className=" highlighter-rouge">
...
gulp open-app
 ...
 for opening the Dashboard Page (default) of the product. You can set in gulpfile.js from your downloaded archive any page you want to open in browser, at line 30: <code className=" highlighter-rouge">
gulp.src('index.html')
</code>
.
</li>
...
<p>
We have created two options for the background of sections. You can go with a black or orange color. We built an attribute named <code className=" highlighter-rouge">
data-background-color="color"
</code>
, so at once you add this attribute to <code className=" highlighter-rouge">
div
</code>
 with class <code className=" highlighter-rouge">
.section
</code>
 you can access our two background options color. To see how they look, you can check them out below.
</p>
<div className=" bd-example" data-example-id="">
<span className=" pick-class-label label-tooltip" data-background-color="orange" data-placement="top" id="tooltip707752670">
</span>
<UncontrolledTooltip delay={0} placement="top" target="tooltip707752670">
data-background-color='orange'
</UncontrolledTooltip>
<span className=" pick-class-label label-tooltip" data-background-color="black" data-placement="top" id="tooltip264630757">
</span>
<UncontrolledTooltip delay={0} placement="top" target="tooltip264630757">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="text-left">
                  ...
                  into{" "}
                  <code className="highlighter-rouge">
                    src/assets/css/now-ui-kit.css.map
                  </code>
                  .
                </td>
                <td className="text-right">
