...
<title>
Carousel - Now UI Kit by Creative Tim
</title>
...
<p>
In browsers where the <a href="https://www.w3.org/TR/page-visibility/">
Page Visibility API
</a>
...
<p>
Lastly, if you’re building our JavaScript from source, it requires <code className=" highlighter-rouge">
util.js
</code>
</p>
<h2 id="example">
...
<li className=" active" data-slide-to="1" data-target="#carouselExampleIndicators">
</li>
...
<p>
If you want to see more examples and properties please check the official <a href="http://getbootstrap.com/docs/4.0/components/carousel/">
