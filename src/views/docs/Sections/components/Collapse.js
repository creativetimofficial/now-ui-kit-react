...
<title>
Collapse - Now UI Kit by Creative Tim
</title>
...
<p>
You can use a link with the <code className=" highlighter-rouge">
href
</code>
 attribute, or a button with the <code className=" highlighter-rouge">
data-target
</code>
 attribute. In both cases, the <code className=" highlighter-rouge">
...
<p>
<Button aria-controls="collapseExample" aria-expanded={false} color="primary" data-toggle="collapse" href="#pablo" onClick={e =>
 e.preventDefault()}>
 Link with href 
</Button>
<Button aria-controls="collapseExample" aria-expanded={false} color="primary" data-target="#collapseExample" data-toggle="collapse" type="button">
 Button with data-target 
</Button>
</p>
<UncontrolledCollapse id="collapseExample" toggler="#collapseExample">
...
<p>
Using the <a href="/docs/1.0/components/card/">
card
</a>
...
<a aria-controls="collapseOne" aria-expanded={true} data-parent="#accordion" data-toggle="collapse" href="#pablo" id="collapseOne" onClick={e =>
 e.preventDefault()}>
 Collapsible Group Item #1 <i className=" now-ui-icons arrows-1_minimal-down">
</i>
</a>
</CardHeader>
<UncontrolledCollapse aria-labelledby="headingOne" className=" show" id="collapseOne" role="tabpanel" toggler="#collapseOne">
<CardBody>
...
<a aria-controls="collapseTwo" aria-expanded={false} className=" collapsed" data-parent="#accordion" data-toggle="collapse" href="#pablo" id="collapseTwo" onClick={e =>
 e.preventDefault()}>
 Collapsible Group Item #2 <i className=" now-ui-icons arrows-1_minimal-down">
</i>
</a>
</CardHeader>
<UncontrolledCollapse aria-labelledby="headingTwo" id="collapseTwo" role="tabpanel" toggler="#collapseTwo">
<CardBody>
 Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS. 
</CardBody>
</UncontrolledCollapse>
...
<a aria-controls="collapseThree" aria-expanded={false} className=" collapsed" data-parent="#accordion" data-toggle="collapse" href="#pablo" id="collapseThree" onClick={e =>
 e.preventDefault()}>
 Collapsible Group Item #3 <i className=" now-ui-icons arrows-1_minimal-down">
</i>
</a>
</CardHeader>
<UncontrolledCollapse aria-labelledby="headingThree" id="collapseThree" role="tabpanel" toggler="#collapseThree">
<CardBody>
 Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS. 
</CardBody>
</UncontrolledCollapse>
...
<p>
You can also create accordions with custom markup. Add the <code className=" highlighter-rouge">
data-children
</code>
 attribute and specify a set of sibling elements to toggle (e.g., <code className=" highlighter-rouge">
.item
</code>
). Then, use the same attributes and classes as shown above for connecting toggles to their associated content.
</p>
<div className=" bd-example" data-example-id="">
<div data-children=".item" id="exampleAccordion">
<div className=" item">
<a aria-controls="exampleAccordion1" aria-expanded={true} data-parent="#exampleAccordion" data-toggle="collapse" href="#pablo" id="exampleAccordion1" onClick={e =>
 e.preventDefault()}>
 Toggle item 
</a>
<UncontrolledCollapse className=" show" id="exampleAccordion1" role="tabpanel" toggler="#exampleAccordion1">
<p className=" mb-3">
...
<div className=" item">
<a aria-controls="exampleAccordion2" aria-expanded={false} data-parent="#exampleAccordion" data-toggle="collapse" href="#pablo" id="exampleAccordion2" onClick={e =>
 e.preventDefault()}>
 Toggle item 2 
</a>
<UncontrolledCollapse id="exampleAccordion2" role="tabpanel" toggler="#exampleAccordion2">
<p className=" mb-3">
...
<p>
If you want to see more examples and properties please check the official <a href="http://getbootstrap.com/docs/4.0/components/collapse/">
