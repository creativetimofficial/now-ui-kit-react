...
<title>
Buttons - Now UI Kit by Creative Tim
</title>
...
<Button className=" btn-neutral" color="default" type="button">
Neutral
</Button>
</div>
<h2 id="style-buttons">
...
<li>
Disabled buttons should include the <code className=" highlighter-rouge">
aria-disabled="true"
</code>
...
<h4 id="link-functionality-caveat">
Link functionality caveat
</h4>
<p>
...
pointer-events: none
 ...
 to try to disable the link functionality of <code className=" highlighter-rouge">
<a>
</code>
s, but that CSS property is not yet standardized. In addition, even in browsers that do support <code className=" highlighter-rouge">
pointer-events: none
</code>
, keyboard navigation remains unaffected, meaning that sighted keyboard users and users of assistive technologies will still be able to activate these links. So to be safe, add a <code className=" highlighter-rouge">
tabindex="-1"
</code>
...
<p>
If you want to see more examples and properties please check the official <a href="http://getbootstrap.com/docs/4.0/components/buttons/">
