...
<title>
How to set up Google API Keys - Now UI Kit by Creative Tim
</title>
...
<ol>
<li>
Go to <a href="https://developers.google.com/maps/documentation/javascript/get-api-key">
...
<li>
Get the Key and place it in your project where is this script:<code className=" highlighter-rouge">
