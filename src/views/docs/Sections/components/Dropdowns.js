...
<p>
Dropdowns are toggleable, contextual overlays for displaying lists of links and more. They’re made interactive with the included Bootstrap dropdown JavaScript plugin. They’re toggled by clicking, not by hovering; this is <a href="http://markdotto.com/2012/02/27/bootstrap-explained-dropdowns/">
an intentional design decision.
</a>
</p>
<p>
Dropdowns are built on a third party library, <a href="https://popper.js.org/">
Popper.js
</a>
, which provides dynamic positioning and viewport detection. Be sure to include <a href="">
popper.min.js
</a>
 before Bootstrap’s JavaScript or use <code className=" highlighter-rouge">
...
<p>
If you want to see more examples and properties please check the official <a href="http://getbootstrap.com/docs/4.0/components/dropdowns/">
