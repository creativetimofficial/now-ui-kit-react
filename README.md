...
We use GitHub Issues as the official bug tracker for the Now UI Kit 2. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Now UI Kit 2. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/?ref=nukr-github-readme).
